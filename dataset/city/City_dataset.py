...
root_city = '/hpc/users/CONNECT/yunhaoluo/datasets/citys/cps/'
#-------------------Cityscapes dataset path-------------------#
...
class CityDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir, split='train_aug',use_difficult=False, is_train = True, augment = None, cutmix=False, base_size=520, crop_size=480, file_length=None, norm_mean=[0.5, 0.5, 0.5], norm_std=[0.5, 0.5, 0.5],pass_like=False):
